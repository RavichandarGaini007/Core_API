...
namespace Login_API.Controllers
{
    ...
    [ApiController]
    public class ModernTradeController : ControllerBase
    {
        private readonly IPurchaseSaleService _purchaseSaleService;
        private readonly IConfiguration _config;
        public ModernTradeController(IPurchaseSaleService purchaseSaleService, IConfiguration configuration)
        {
        ...
        public string generateToken(string userName,string password)
        {
            try
            {
                var response=_purchaseSaleService.getToken(userName,password);
